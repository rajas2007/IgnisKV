...
func NewDispatcher(s *store.MemoryStore) *Dispatcher {
	...
	d.handlers["HEXISTS"] = NewHExistsHandler(s)
	d.handlers["HDEL"] = NewHDelHandler(s)
	d.handlers["HLEN"] = NewHLenHandler(s)
	d.handlers["HGETALL"] = NewHGetAllHandler(s)
	d.handlers["HMGET"] = NewHMGetHandler(s)
	d.handlers["HKEYS"] = NewHKeysHandler(s)
	d.handlers["HVALS"] = NewHValsHandler(s)
	d.handlers["HSTRLEN"] = NewHStrLenHandler(s)
	d.handlers["HSETNX"] = NewHSetNXHandler(s)
